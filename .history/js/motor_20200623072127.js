...
//LEE BASE DE DATOS Y COLOCA EN LAS POSICIONES
//poner en onload

function ponerEnPosicion() {    
    ...
    var d = snapshot.val();  
    var posic = d.posicion;
    var table = document.getElementById(posic);
    ...
    cell1.innerHTML = d.producto;
    cell2.innerHTML = d.lote;
    cell3.innerHTML = d.cantidad;
        
    });
    // setTimeout(ponerEnPosicion,5000);
    
}

function mensaje() {    console.log("hola desde javascript");
}
