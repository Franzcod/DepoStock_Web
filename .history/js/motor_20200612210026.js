...
function busca_user() {    
    ...
    var refe = db.ref("productos/");

    var pos= refe.ref("posicion/");
    ...
    ref.orderByChild("posicion").on("child_added", function(snapshot){
    //repite el proceso como cuantas referencias encuentre y los asigna a la lista "d"
        
        var table = document.getElementById(pos);
        var d = snapshot.val();        
        {
